...
if(!list){
    const embed = new EmbedBuilder()
    .setAuthor({name: `RoleSetup Panel`, iconURL: client.user.avatarURL({dynamic: true})})
.setTitle("**__RoleSetup Cmd__**")
...
if(girl === 'na'){
    ...
    const embed = new EmbedBuilder()
        .setColor(client.color)
      .setFooter({text: `Requested by` + message.author.tag, iconURL: message.author.displayAvatarURL()})
    .setAuthor({name: `RoleSetup Panel`,iconURL: client.user.displayAvatarURL()})
        .setTitle('**__Custom Role List__**')
        .addFields(
            { name: '<a:Green_Dot:1143870972844326963> **Required Role**', value: `${req}`, inline: true },
            { name: '<a:Green_Dot:1143870972844326963> **Official Role**', value: `${official}`, inline: true },
            { name: '<a:Green_Dot:1143870972844326963> **Friend Role**', value: `${frd}`, inline: true },
            { name: '<a:Green_Dot:1143870972844326963> **Guest Role**', value: `${guest}`, inline: true },
            { name: '<a:Green_Dot:1143870972844326963> **Vip Role**', value: `${vip}`, inline: true },
            { name: '<a:Green_Dot:1143870972844326963> **Girl Role**', value: `${girl}`, inline: true },
        )
