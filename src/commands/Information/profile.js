...
const frv = sus.roles.cache.has("1064273965410947083");
      if(frv === true) badges = badges + `\n<a:x_diamonds:1241429811256365096>・**Supporter**`;
...
else if(badges === "") badges = "\n**You don't have any badges.\nJoin our [Support HQ](https://discord.gg/3QVgzxHMn8) to get some of the badges.**";
        }
      const pr = new EmbedBuilder()
.setAuthor({name: `Profile & Badge Panel`, iconURL: client.user.displayAvatarURL({dynamic: true})})
...
${badges ? badges : "\n**You don't have any badges.\nJoin our [Support HQ](https://discord.gg/SSyJ7KssAG) to get some of the badges.**"}`)
